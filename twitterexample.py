...
print
print "---------------------------------------------------------------------"
print 'Example 7. Creating a basic frequency distribution from the words in tweets'
...
print "---------------------------------------------------------------------"
print 'Example 8. Using prettytable to display tuples in a nice tabular format'
...
print
print "---------------------------------------------------------------------"
print 'Example 9. Calculating lexical diversity for tweets'
...
print
raw_input("Press Enter to see Example 10 ")
print

print "---------------------------------------------------------------------"
print 'Example 10. Finding the most popular retweets'
...
print
raw_input("Press Enter to see Example 11 ")
print

print "---------------------------------------------------------------------"
print 'Example 11. Looking up users who have retweeted a status'
...
print
raw_input("Press Enter to see Example 12 ")
print

print "---------------------------------------------------------------------"
print 'Example 12. Plotting frequencies of words'
...
print
raw_input("Press Enter to see Example 13 ")
print

print "---------------------------------------------------------------------"
print 'Example 13. Generating histograms of words, screen names, and hashtags'
...
print
raw_input("Press Enter to see Example 14 ")
print

print "---------------------------------------------------------------------"
print 'Example 14. Generating a histogram of retweet counts'
...
print counts
print
raw_input("Press Enter to see Example 15 ")
print

print "---------------------------------------------------------------------"
print 'Example 15. Sentiment Analysis '
